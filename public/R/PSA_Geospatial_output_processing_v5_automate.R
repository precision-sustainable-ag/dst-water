...
geospatial_processing <- function(FileDir, Init, cc_termination_date, Processed_model_out_filepath, Processed_model_out_filename){
  ...
  # Process Init file
  Init <- Init %>%
    dplyr::select(ID, lat, long, altitude, population, end) %>%
  ...
  # corn related metrices
   corn_out <- model_input_data %>%
      ...
      dplyr:: mutate(totalDM = round((totalDM * population/1000), 2), # converting from g/plant into kg/ha
                     ...
                     cum_ETsp =   round((cum_ETsply * population * 1000 * 1/(10000 * 1000 * 1000)),2),
   ...
   # water balance related metrics
    water_out <- model_out %>%
      ...
      dplyr::mutate(dt_cct = Date_cc_termination,
                    ...
                    P_Ev_B4P = round(((SeasPSoEv_Sowing - SeasPSoEv_cc_termination) * population * 1000 * 1/(10000 * 1000 * 1000)),2), # Converting from g/plant to mm.
                    P_Ev_EVg = round(((SeasPSoEv_Tasselinit - SeasPSoEv_Sowing) * population * 1000 * 1/(10000 * 1000 * 1000)),2),
                    P_Ev_LVg = round(((SeasPSoEv_Silked - SeasPSoEv_Tasselinit) * population * 1000 * 1/(10000 * 1000 * 1000)),2),
                    P_Ev_Slk = round(((SeasPSoEv_grainFill - SeasPSoEv_Silked) * population * 1000 * 1/(10000 * 1000 * 1000)),2),
                    P_Ev_Gf = round(((ifelse(is.na(SeasPSoEv_Matured), SeasPSoEv_Sim_ended, SeasPSoEv_Matured) - SeasPSoEv_grainFill) * population * 1000 * 1/(10000 * 1000 * 1000)),2),
                    P_Ev_Veg = round(((SeasPSoEv_Silked - SeasPSoEv_Sowing) * population * 1000 * 1/(10000 * 1000 * 1000)),2),
                    P_Ev_Rep = round(((ifelse(is.na(SeasPSoEv_Matured), SeasPSoEv_Sim_ended, SeasPSoEv_Matured) - SeasPSoEv_Silked) * population * 1000 * 1/(10000 * 1000 * 1000)),2),
                    P_Ev_cum = round(((ifelse(is.na(SeasPSoEv_Matured), SeasPSoEv_Sim_ended, SeasPSoEv_Matured) - SeasPSoEv_Sowing) * population * 1000 * 1/(10000 * 1000 * 1000)),2),
                    A_Ev_B4P = round(((SeasASoEv_Sowing - SeasASoEv_cc_termination) * population * 1000 * 1/(10000 * 1000 * 1000)),2),
                    A_Ev_EVg = round(((SeasASoEv_Tasselinit - SeasASoEv_Sowing) * population * 1000 * 1/(10000 * 1000 * 1000)),2),
                    A_Ev_LVg = round(((SeasASoEv_Silked - SeasASoEv_Tasselinit) * population * 1000 * 1/(10000 * 1000 * 1000)),2),
                    A_Ev_Slk = round(((SeasASoEv_grainFill - SeasASoEv_Silked) * population * 1000 * 1/(10000 * 1000 * 1000)),2),
                    A_Ev_Gf = round(((ifelse(is.na(SeasASoEv_Matured), SeasASoEv_Sim_ended, SeasASoEv_Matured) - SeasASoEv_grainFill) * population * 1000 * 1/(10000 * 1000 * 1000)),2),
                    A_Ev_Veg = round(((SeasASoEv_Silked - SeasASoEv_Sowing) * population * 1000 * 1/(10000 * 1000 * 1000)),2),
                    A_Ev_Rep = round(((ifelse(is.na(SeasASoEv_Matured), SeasASoEv_Sim_ended, SeasASoEv_Matured) - SeasASoEv_Silked) * population * 1000 * 1/(10000 * 1000 * 1000)),2),
                    A_Ev_cum = round(((ifelse(is.na(SeasASoEv_Matured), SeasASoEv_Sim_ended, SeasASoEv_Matured) - SeasASoEv_Sowing) * population * 1000 * 1/(10000 * 1000 * 1000)),2),
                    P_Tr_B4P = round(((SeasPTran_Sowing - SeasPTran_cc_termination) * population * 1000 * 1/(10000 * 1000 * 1000)),2),
                    P_Tr_EVg = round(((SeasPTran_Tasselinit - SeasPTran_Sowing) * population * 1000 * 1/(10000 * 1000 * 1000)),2),
                    P_Tr_LVg = round(((SeasPTran_Silked - SeasPTran_Tasselinit) * population * 1000 * 1/(10000 * 1000 * 1000)),2),
                    P_Tr_Slk = round(((SeasPTran_grainFill - SeasPTran_Silked) * population * 1000 * 1/(10000 * 1000 * 1000)),2),
                    P_Tr_Gf = round(((ifelse(is.na(SeasPTran_Matured), SeasPTran_Sim_ended, SeasPTran_Matured) - SeasPTran_grainFill) * population * 1000 * 1/(10000 * 1000 * 1000)),2),
                    P_Tr_Veg = round(((SeasPTran_Silked - SeasPTran_Sowing) * population * 1000 * 1/(10000 * 1000 * 1000)),2),
                    P_Tr_Rep = round(((ifelse(is.na(SeasPTran_Matured), SeasPTran_Sim_ended, SeasPTran_Matured) - SeasPTran_Silked) * population * 1000 * 1/(10000 * 1000 * 1000)),2),
                    P_Tr_cum = round(((ifelse(is.na(SeasPTran_Matured), SeasPTran_Sim_ended, SeasPTran_Matured) - SeasPTran_Sowing) * population * 1000 * 1/(10000 * 1000 * 1000)),2),
                    A_Tr_B4P = round(((SeasATran_Sowing - SeasATran_cc_termination) * population * 1000 * 1/(10000 * 1000 * 1000)),2),
                    A_Tr_EVg = round(((SeasATran_Tasselinit - SeasATran_Sowing) * population * 1000 * 1/(10000 * 1000 * 1000)),2),
                    A_Tr_LVg = round(((SeasATran_Silked - SeasATran_Tasselinit) * population * 1000 * 1/(10000 * 1000 * 1000)),2),
                    A_Tr_Slk = round(((SeasATran_grainFill - SeasATran_Silked) * population * 1000 * 1/(10000 * 1000 * 1000)),2),
                    A_Tr_Gf = round(((ifelse(is.na(SeasATran_Matured), SeasATran_Sim_ended, SeasATran_Matured) - SeasATran_grainFill) * population * 1000 * 1/(10000 * 1000 * 1000)),2),
                    A_Tr_Veg = round(((SeasATran_Silked - SeasATran_Sowing) * population * 1000 * 1/(10000 * 1000 * 1000)),2),
                    A_Tr_Rep = round(((ifelse(is.na(SeasATran_Matured), SeasATran_Sim_ended, SeasATran_Matured) - SeasATran_Silked) * population * 1000 * 1/(10000 * 1000 * 1000)),2),
                    A_Tr_cum = round(((ifelse(is.na(SeasATran_Matured), SeasATran_Sim_ended, SeasATran_Matured) - SeasATran_Sowing) * population * 1000 * 1/(10000 * 1000 * 1000)),2),
                    Rain_B4P = round(((SeasRain_Sowing - SeasRain_cc_termination) * population * 1000 * 1/(10000 * 1000 * 1000)),2),
                    Rain_EVg = round(((SeasRain_Tasselinit - SeasRain_Sowing) * population * 1000 * 1/(10000 * 1000 * 1000)),2),
                    Rain_LVg = round(((SeasRain_Silked - SeasRain_Tasselinit) * population * 1000 * 1/(10000 * 1000 * 1000)),2),
                    Rain_Slk = round(((SeasRain_grainFill - SeasRain_Silked) * population * 1000 * 1/(10000 * 1000 * 1000)),2),
                    Rain_Gf = round(((ifelse(is.na(SeasRain_Matured), SeasRain_Sim_ended, SeasRain_Matured) - SeasRain_grainFill) * population * 1000 * 1/(10000 * 1000 * 1000)),2),
                    Rain_Veg = round(((SeasRain_Silked - SeasRain_Sowing) * population * 1000 * 1/(10000 * 1000 * 1000)),2),
                    Rain_Rep = round(((ifelse(is.na(SeasRain_Matured), SeasRain_Sim_ended, SeasRain_Matured) - SeasRain_Silked) * population * 1000 * 1/(10000 * 1000 * 1000)),2),
                    Rain_cum = round(((ifelse(is.na(SeasRain_Matured), SeasRain_Sim_ended, SeasRain_Matured) - SeasRain_Sowing) * population * 1000 * 1/(10000 * 1000 * 1000)),2),
                    Infl_B4P = round(((SeasInfil_Sowing - SeasInfil_cc_termination) * population * 1000 * 1/(10000 * 1000 * 1000)),2),
                    Infl_EVg = round(((SeasInfil_Tasselinit - SeasInfil_Sowing) * population * 1000 * 1/(10000 * 1000 * 1000)),2),
                    Infl_LVg = round(((SeasInfil_Silked - SeasInfil_Tasselinit) * population * 1000 * 1/(10000 * 1000 * 1000)),2),
                    Infl_Slk = round(((SeasInfil_grainFill - SeasInfil_Silked) * population * 1000 * 1/(10000 * 1000 * 1000)),2),
                    Infl_Gf = round(((ifelse(is.na(SeasInfil_Matured), SeasInfil_Sim_ended, SeasInfil_Matured) - SeasInfil_grainFill) * population * 1000 * 1/(10000 * 1000 * 1000)),2),
                    Infl_Veg = round(((SeasInfil_Silked - SeasInfil_Sowing) * population * 1000 * 1/(10000 * 1000 * 1000)),2),
                    Infl_Rep = round(((ifelse(is.na(SeasInfil_Matured), SeasInfil_Sim_ended, SeasInfil_Matured) - SeasInfil_Silked) * population * 1000 * 1/(10000 * 1000 * 1000)),2),
                    Infl_cum = round(((ifelse(is.na(SeasInfil_Matured), SeasInfil_Sim_ended, SeasInfil_Matured) - SeasInfil_Sowing) * population * 1000 * 1/(10000 * 1000 * 1000)),2)) %>%
    ...
    stress_out <- model_out %>%
      ...
      dplyr::mutate(N_dmd = round((N_dmd * population/1000),2),
                    N_upt = round((N_upt * population/1000),2),
                    cum_ETdmd = round((cum_ETdmd * population * 1000 * 1/(10000 * 1000 * 1000)),2),
                    cum_ETsply = round((cum_ETsply * population * 1000 * 1/(10000 * 1000 * 1000)),2)) %>%
...
#For this, make sure to create a folder named 'processed_model_outputs' in your local computer and specify its path in Ln 359.
    Processed_model_out_filepath <- "F:/PSA_projects/CROWN_Geospatial/MD_processed_model_outputs/script_v5/"
